...
const EditBtn: React.FC<ModalProp> = ({ name, studentID, number, yearClass, Class, username, password }) => {
    ...
    return (
        <>
            ...
            <EditModal name={name} studentID={studentID} number={number} yearClass={yearClass} Class={Class} username={username} password={password} />
        </>
    )
}
