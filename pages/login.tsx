    ...
    const submit = async () => {
        Swal.fire({
            ...
            didOpen: async () => {
                ...
                if (await getData()) return setTimeout(swalSuccess, 2000);

                setTimeout(swalError, 2000);
                    ...
                    <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form className="space-y-4 md:space-y-6">
                                <div>
                                    <label htmlFor="username" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">ชื่อผู้ใช้ (ชื่อไม่มีนามสกุล)</label>
                                ...
                                <div>
                                    <label htmlFor="password" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">รหัสผ่าน (รหัสนักเรียน)</label>
